...
<main>
	<h1>Bonjour / Hello</h1>
	<article>
		<a href="https://vincjo.fr/svelte-simple-datatables/">
			...
			<div>
				...
				<h3>A Datatable component for Svelte</h3>
			</div>
		</a>
	</article>	

	<article>
		<a href="https://vincjo.fr/svelte-data-handler/">
			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="512" height="512" viewBox="0 0 24 24">
				<path fill="#F66B0E" d="M21 2H3C1.9 2 1 2.9 1 4V20C1 21.1 1.9 22 3 22H21C22.1 22 23 21.1 23 20V4C23 2.9 22.1 2 21 2M21 20H3V6H21V20M6 8V18H10V16H8V10H10V8H6M16 16H14V18H18V8H14V10H16V16" />
			</svg>
			<div>
				<h2 style:color={'#F66B0E'}>svelte-data-handler</h2>
				<h3 style:color={'#205375'}>Easily manipulate an array of objects</h3>
			</div>
		</a>
	</article>	
</main>
...
<style>
	...
	svg{float:left;width:104px;height:104px;margin-right:24px;}
	...
	@media (max-width: 640px) {
		...
		svg{width:64px;height:64px;margin-right:16px;}
		a{padding:8px}
